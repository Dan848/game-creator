...
@section('content')
    <div class="container mb-5">
        ...
        <ol class="breadcrumb mb-4">
            ...
            <li class="breadcrumb-item active">Nuovo Personaggio</li>
        </ol>
    </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-floating mb-3">
                                <input id="strength" type="number"
                                    ...
                                    value="{{ old('strength') }}" required autofocus>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-floating mb-3">
                                <input id="intelligence" type="number"
                                    ...
                                    value="{{ old('intelligence') }}" autofocus>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-floating mb-3">
                                <input id="defence" type="number"
                                    ...
                                    value="{{ old('defence') }}" required autofocus>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-floating mb-3">
                                <input id="life" type="number"
                                    ...
                                    value="{{ old('life') }}" required autofocus>
                        ...
                        <div class="form-floating col-12 col-md-6">
                            <select class="form-select" name="type_id" id="type_id" aria-label="Realizzato con">
                                <option value="{{ old('type_id') }}" selected>Seleziona la classe di partenza</option>
