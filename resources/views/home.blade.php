                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item">Intelligenza: <strong>{{$character["intelligence"]}}</strong></li>
                            <li class="list-group-item">Vita: <strong>{{$character["life"]}}</strong></li>
                            <li class="list-group-item">Descrizione: <strong> {{$character["description"]}} </strong> </li>
                        </ul>
                    </div>
